...
INSERT INTO "new_ContentList" ("content_status", "creation_timestamp", "genres", "global_rating", "id", "images", "name", "personal_rating", "type") SELECT "content_status", "creation_timestamp", "genres", "global_rating", "id", "images", "name", "personal_rating", "type" FROM "ContentList";
