/*
  ...
  - You are about to drop the column `type` on the `ContentList` table. All the data in the column will be lost.
...
INSERT INTO "new_ContentList" ("content_status", "content_type", "creation_timestamp", "genres", "global_rating", "id", "images", "name", "personal_rating", "record_timestamp") SELECT "content_status", "content_type", "creation_timestamp", "genres", "global_rating", "id", "images", "name", "personal_rating", "record_timestamp" FROM "ContentList";
